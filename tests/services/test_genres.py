...
class TestGenresService:
    ...
    def genres_dao_mock(self, dao_mock):
        ...
        dao.get_all_sortid.return_value = [
    ...
    def test_get_genres(self, genres_dao_mock, genres_service, page):
        genres = genres_service.get_all_sortid(page=page)
        assert len(genres) == 2
        assert genres == genres_dao_mock.get_all_sortid.return_value
        genres_dao_mock.get_all_sortid.assert_called_with(page=page)
